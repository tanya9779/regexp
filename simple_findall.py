...
# 1 a 1 2 b ---> a, b
# z 2 y     ---> z, y
REGEXP_1 = '[a-z]{1}' # только буквы по одной

# aaa bbb ccc ---> aaa, bbb, ccc
# ddd eee fgh ---> ddd, eee, fgh
# a1b c2d e3f ---> a1b, c2d, e3f
REGEXP_2 = '[a-zA-Z0-9]{3}' # группы/цифры группами по три

# a aa aaa ---> aa, aaa
# b bb bbb ---> bb, bbb
# a bb aaa ---> bb, aaa
REGEXP_3 = '[a-z]{2,3}' # строчные буквы группами по 2 или по 3
...
REGEXP_4 = '[0-9]+\.[0-9]+\.[0-9]+\.[0-9]' # цифры поделенные на 4 группы точками

# aaa Abbb ccc ---> Abbb
# Aaa Abbb ccc ---> Aaa, Abbb
# Caa Cbb Accc ---> Accc
REGEXP_5 = 'A[a-z]{2,3}' # группы по 3 или 4 буквы с первой Заглавной

# a b c d e f ---> a, b, e, f
# abcdef      ---> a, b, e, f
# adf         ---> a, f
# acf         ---> a, f
REGEXP_6 = '[abef]' # одна из букв abef

# aaa +1.0 bb              ---> +1.0
# aaa -1.0 bb              ---> -1.0
# aaa -123.234 bb +111.999 ---> -123.234, +111.999
REGEXP_7 = '[\+\-][0-9]+[\.][0-9]+'  # десятичная точка должна быть экранирована конструкцией \.
...
REGEXP_8 = '[0-9]{2}[-\./][0-9]+[-\./][0-9]{4}'  # один из разделителей - или . или /
